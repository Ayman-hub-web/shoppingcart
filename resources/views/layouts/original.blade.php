...
<body class="home-page home-01 ">
	...
	<!--header-->
	<header id="header" class="header header-style-1" style="margin-bottom:5px;">
							...
							<ul>
								...
								<li class="menu-item menu-item-has-children parent" >
									...
									<ul class="submenu curency" >
										...
										<form id="logout.form" method="post" action="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout.form').submit();">
											@csrf 
										</form>
									</ul>
								</li>
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="{{route('cart.index')}}" class="link-to-home"><img src="{{asset('assets/images/logo-top-1.png')}}" alt="mercado"></a>
						</div>
						...
						<div class="wrap-icon right-section">
							...
							<div class="wrap-icon-section minicart">
								<a href="{{route('cart.show')}}" class="link-direction">
									<i class="fa fa-shopping-basket" aria-hidden="true"></i>
									<div class="left-info">
										<span class="index">@if(Session::has('cart')) {{session()->get('cart')->totalQty}} @else 0 @endif</span>
